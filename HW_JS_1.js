...
let item_7;
item_7 = String(item_6);// 22. Создать переменную item_7 и в ней преобразовать item_6 в String.
...
if (age_1 < age_2) {         // 30. Если age_1 < age_2, вывести в консоль “You don’t have access cause your age is ” + age_1 + “ It’s less then ”
 ...
 if (age_1 >= age_2 && age_1 < age_3) {  // 31. Если age_1 >=  age_2 и age_1 <  age_3, вывести в консоль “Welcome  !”
    console.log("Welcome  !")
} else
if (age_1 > age_3) { // 32. Если age_1  > age_3, вывести в консоль “Keep calm and look Culture channel”.
